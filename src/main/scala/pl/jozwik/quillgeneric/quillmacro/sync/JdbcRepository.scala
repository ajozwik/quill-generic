...
import pl.jozwik.quillgeneric.quillmacro.sync.JdbcRepository.{ JdbcContextDateQuotes, SqlCompositeKeyContextDateQuotes }
...
object JdbcRepository {
  ...
  type SqlCompositeKeyContextDateQuotes[D <: SqlIdiom, N <: NamingStrategy] = JdbcContext[D, N] with CompositeKeyCrudWithContext with DateQuotes
}
