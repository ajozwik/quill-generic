...
Example usage in:
 ...
 - [PersonRepository](/src/test/scala/pl/jozwik/quillgeneric/sync/PersonRepository.scala) and [MyPersonRepository](src/test/scala/pl/jozwik/quillgeneric/sync/MyPersonRepository.scala) (example of usage macro method like searchByFilter, count)
